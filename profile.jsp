            ...
            <div class="row my-3 p-3">
               <div class="form-content">
                  <form method="post" enctype="multipart/form-data">
                     <input type="hidden" name="csrfmiddlewaretoken" value="FLCDxaUQDDqPZ2dbstC5AKlofRyOeUavd8IuJCjJM88G1L89OEYH6OiKqlMNBD3x">
                     <div class="form-row">
                        <div class="col-md-12">
                           <div class="form-group">
                              <label class="small mb-1">Username:</label>
                              <input type="text" name="username" value="user01" class="form-control" maxlength="100" required id="id_username">
                              <label class="small mb-1">Email:</label>
                              <input type="text" name="email" value="user@gmail.com" class="form-control" required id="id_email">
                           </div>
                           <div class="form-group">
                           ...
                           <textarea name="bio" cols="40" rows="5" class="form-control" required id="id_bio">
</textarea>
                        </div>
                     </div>
                     <br><br>
