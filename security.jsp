...
<html>
   ...
   <body style="
      ...
      <form action="security.jsp" method="get">
      		<label>Recorded Voice Samples</label> <br>
				<input list="browsers">
		...
		<datalist id="browsers">
		  ...
		  <option value="UserC">
									  ...
									  <button type="submit" formaction="security.jsp">Record new sample</button>
							  							  <button type="submit" formaction="security.jsp">Delete sample</button>
